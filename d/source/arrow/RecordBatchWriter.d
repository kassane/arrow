...
public class RecordBatchWriter : ObjectG
{
	...
	public bool close()
	{
		...
		auto __p = garrow_record_batch_writer_close(gArrowRecordBatchWriter, &err) != 0;
	...
	{
		return garrow_record_batch_writer_is_closed(gArrowRecordBatchWriter) != 0;
	}
	...
	public bool writeRecordBatch(RecordBatch recordBatch)
	{
		...
		auto __p = garrow_record_batch_writer_write_record_batch(gArrowRecordBatchWriter, (recordBatch is null) ? null : recordBatch.getRecordBatchStruct(), &err) != 0;
	...
	public bool writeTable(Table table)
	{
		...
		auto __p = garrow_record_batch_writer_write_table(gArrowRecordBatchWriter, (table is null) ? null : table.getTableStruct(), &err) != 0;
