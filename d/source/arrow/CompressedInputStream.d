...
public class CompressedInputStream : InputStream
{
	...
	public this(Codec codec, InputStream raw)
	{
		...
		auto __p = garrow_compressed_input_stream_new((codec is null) ? null : codec.getCodecStruct(), (raw is null) ? null : raw.getArrowInputStreamStruct(), &err);
		...
		this(cast(GArrowCompressedInputStream*) __p, true);
	}
}
