...
public class StringArrayBuilder : BinaryArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_string_array_builder_new();
		...
		this(cast(GArrowStringArrayBuilder*) __p, true);
	}
	...
	public bool append(string value)
	{
		...
		auto __p = garrow_string_array_builder_append(gArrowStringArrayBuilder, Str.toStringz(value), &err) != 0;
	...
	public bool appendString(string value)
	{
		...
		auto __p = garrow_string_array_builder_append_string(gArrowStringArrayBuilder, Str.toStringz(value), &err) != 0;
	 ...
	 * Throws: GException on failure.
	 */
	public bool appendStringLen(string value, int length)
	{
		GError* err = null;

		auto __p = garrow_string_array_builder_append_string_len(gArrowStringArrayBuilder, Str.toStringz(value), length, &err) != 0;
	...
	public bool appendStrings(string[] values, bool[] isValids)
	{
		...
		auto __p = garrow_string_array_builder_append_strings(gArrowStringArrayBuilder, Str.toStringzArray(values), cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
	...
	public bool appendValue(string value)
	{
		...
		auto __p = garrow_string_array_builder_append_value(gArrowStringArrayBuilder, Str.toStringz(value), &err) != 0;
	...
	public bool appendValues(string[] values, bool[] isValids)
	{
		...
		auto __p = garrow_string_array_builder_append_values(gArrowStringArrayBuilder, Str.toStringzArray(values), cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
