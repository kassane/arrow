...
public class CSVReadOptions : ObjectG
{
	...
	public this()
	{
		auto __p = garrow_csv_read_options_new();
		...
		this(cast(GArrowCSVReadOptions*) __p, true);
	}
	...
	/** */
	public void addTimestampParser(TimestampParser parser)
	{
		garrow_csv_read_options_add_timestamp_parser(gArrowCSVReadOptions, (parser is null) ? null : parser.getTimestampParserStruct());
	}
	...
	{
		auto __p = garrow_csv_read_options_get_column_types(gArrowCSVReadOptions);
	...
	/**
	 * Returns: The values to be processed as false.
	 *
	 *     If the number of values is zero, this returns %NULL.
	 *
	 *     It's a %NULL-terminated string array. It must be freed with
	...
	/**
	 * Returns: The values to be processed as null.
	 *
	 *     If the number of values is zero, this returns %NULL.
	 *
	 *     It's a %NULL-terminated string array. It must be freed with
	 ...
	 * Since: 16.0.0
	 */
	public ListG getTimestampParsers()
	{
		auto __p = garrow_csv_read_options_get_timestamp_parsers(gArrowCSVReadOptions);
	...
	/**
	 * Returns: The values to be processed as true.
	 *
	 *     If the number of values is zero, this returns %NULL.
	 *
	 *     It's a %NULL-terminated string array. It must be freed with
	...
	/** */
	public void setTimestampParsers(ListG parsers)
	{
		garrow_csv_read_options_set_timestamp_parsers(gArrowCSVReadOptions, (parsers is null) ? null : parsers.getListGStruct());
	}
