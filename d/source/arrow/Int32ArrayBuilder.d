...
public class Int32ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_int32_array_builder_new();
		...
		this(cast(GArrowInt32ArrayBuilder*) __p, true);
	}
	...
	public bool append(int value)
	{
		...
		auto __p = garrow_int32_array_builder_append(gArrowInt32ArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_int32_array_builder_append_null(gArrowInt32ArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_int32_array_builder_append_nulls(gArrowInt32ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(int value)
	{
		...
		auto __p = garrow_int32_array_builder_append_value(gArrowInt32ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(int[] values, bool[] isValids)
	{
		...
		auto __p = garrow_int32_array_builder_append_values(gArrowInt32ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
