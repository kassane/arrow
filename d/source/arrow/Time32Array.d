...
public class Time32Array : NumericArray
{
	...
	{
		auto __p = garrow_time32_array_new((dataType is null) ? null : dataType.getTime32DataTypeStruct(), length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowTime32Array*) __p, true);
	}
	...
	public int[] getValues()
	{
		...
		auto __p = garrow_time32_array_get_values(gArrowTime32Array, &length);
