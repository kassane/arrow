...
public class Int64Array : NumericArray
{
	...
	{
		auto __p = garrow_int64_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowInt64Array*) __p, true);
	}
	...
	public long[] getValues()
	{
		...
		auto __p = garrow_int64_array_get_values(gArrowInt64Array, &length);
	...
	public long sum()
	{
		...
		auto __p = garrow_int64_array_sum(gArrowInt64Array, &err);
