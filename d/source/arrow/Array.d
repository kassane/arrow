...
private import arrow.RunEndEncodeOptions;
private import arrow.RunEndEncodedArray;
...
public class Array : ObjectG
{
	 ...
	 *     dataType = A #GArrowDataType of the C ABI array.
	 * Returns: An imported #GArrowArray
	...
	public static Array import(void* cAbiArray, DataType dataType)
	{
		...
		auto __p = garrow_array_import(cAbiArray, (dataType is null) ? null : dataType.getDataTypeStruct(), &err);
	...
	public Array cast_(DataType targetDataType, CastOptions options)
	{
		...
		auto __p = garrow_array_cast(gArrowArray, (targetDataType is null) ? null : targetDataType.getDataTypeStruct(), (options is null) ? null : options.getCastOptionsStruct(), &err);
	 ...
	 *
	 * Params:
	 *     otherArrays = A #GArrowArray to be
	 *         concatenated.
	 ...
	 * Throws: GException on failure.
	 */
	public Array concatenate(ListG otherArrays)
	{
		GError* err = null;

		auto __p = garrow_array_concatenate(gArrowArray, (otherArrays is null) ? null : otherArrays.getListGStruct(), &err);
	...
	public long count(CountOptions options)
	{
		...
		auto __p = garrow_array_count(gArrowArray, (options is null) ? null : options.getCountOptionsStruct(), &err);
	...
	public StructArray countValues()
	{
		...
		auto __p = garrow_array_count_values(gArrowArray, &err);
		...
		return ObjectG.getDObject!(StructArray)(cast(GArrowStructArray*) __p, true);
	}
	...
	public DictionaryArray dictionaryEncode()
	{
		...
		auto __p = garrow_array_dictionary_encode(gArrowArray, &err);
		...
		return ObjectG.getDObject!(DictionaryArray)(cast(GArrowDictionaryArray*) __p, true);
	}
	 ...
	 * Params:
	 *     otherArray = A #GArrowArray to be compared.
	 *     options = A #GArrowEqualOptions to custom how to compare.
	 * Returns: %TRUE if both of them have the same data, %FALSE
	 *     otherwise.
	 *
	 * Since: 5.0.0
	 */
	public bool equalOptions(Array otherArray, EqualOptions options)
	{
		return garrow_array_equal_options(gArrowArray, (otherArray is null) ? null : otherArray.getArrayStruct(), (options is null) ? null : options.getEqualOptionsStruct()) != 0;
	}
	 ...
	 * Since: 0.4.0
	 */
	public bool equalRange(long startIndex, Array otherArray, long otherStartIndex, long endIndex, EqualOptions options)
	{
		return garrow_array_equal_range(gArrowArray, startIndex, (otherArray is null) ? null : otherArray.getArrayStruct(), otherStartIndex, endIndex, (options is null) ? null : options.getEqualOptionsStruct()) != 0;
	}
	...
	public bool export_(out void* cAbiArray, out void* cAbiSchema)
	{
		...
		auto __p = garrow_array_export(gArrowArray, &cAbiArray, &cAbiSchema, &err) != 0;
	 ...
	 * Returns: The #GArrowArray filtered
	 ...
	 * Throws: GException on failure.
	 */
	public Array filter(BooleanArray filter, FilterOptions options)
	{
		GError* err = null;

		auto __p = garrow_array_filter(gArrowArray, (filter is null) ? null : filter.getBooleanArrayStruct(), (options is null) ? null : options.getFilterOptionsStruct(), &err);
	...
	{
		auto __p = garrow_array_get_null_bitmap(gArrowArray);
	...
	{
		auto __p = garrow_array_get_value_data_type(gArrowArray);
	...
	public BooleanArray isIn(Array right)
	{
		...
		auto __p = garrow_array_is_in(gArrowArray, (right is null) ? null : right.getArrayStruct(), &err);
		...
		return ObjectG.getDObject!(BooleanArray)(cast(GArrowBooleanArray*) __p, true);
	}
	...
	public BooleanArray isInChunkedArray(ChunkedArray right)
	{
		...
		auto __p = garrow_array_is_in_chunked_array(gArrowArray, (right is null) ? null : right.getChunkedArrayStruct(), &err);
	 ...
	 *
	 * Params:
	 *     options = A #GArrowRunEndEncodeOptions.
	 * Returns: A newly created #GArrowRunEndEncodeArray for the @array on success,
	 *     %NULL on error.
	 *
	 * Since: 13.0.0
	 *
	 * Throws: GException on failure.
	 */
	public RunEndEncodedArray runEndEncode(RunEndEncodeOptions options)
	{
		GError* err = null;

		auto __p = garrow_array_run_end_encode(gArrowArray, (options is null) ? null : options.getRunEndEncodeOptionsStruct(), &err);
		...
		return ObjectG.getDObject!(RunEndEncodedArray)(cast(GArrowRunEndEncodedArray*) __p, true);
	}
	...
	{
		auto __p = garrow_array_slice(gArrowArray, offset, length);
	...
	public UInt64Array sortIndices(GArrowSortOrder order)
	{
		...
		auto __p = garrow_array_sort_indices(gArrowArray, order, &err);
	 ...
	 *
	 *
	 * Deprecated: Use garrow_array_sort_indices() instead.
	 *
	 * Returns: The indices that would sort
	...
	public UInt64Array sortToIndices()
	{
		...
		auto __p = garrow_array_sort_to_indices(gArrowArray, &err);
	...
	public Array take(Array indices, TakeOptions options)
	{
		...
		auto __p = garrow_array_take(gArrowArray, (indices is null) ? null : indices.getArrayStruct(), (options is null) ? null : options.getTakeOptionsStruct(), &err);
	...
	public ChunkedArray takeChunkedArray(ChunkedArray indices, TakeOptions options)
	{
		...
		auto __p = garrow_array_take_chunked_array(gArrowArray, (indices is null) ? null : indices.getChunkedArrayStruct(), (options is null) ? null : options.getTakeOptionsStruct(), &err);
	...
	public Array unique()
	{
		...
		auto __p = garrow_array_unique(gArrowArray, &err);
	...
	public Array view(DataType returnType)
	{
		...
		auto __p = garrow_array_view(gArrowArray, (returnType is null) ? null : returnType.getDataTypeStruct(), &err);
