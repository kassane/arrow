...
public class RecordBatchStreamWriter : RecordBatchWriter
{
	...
	public this(OutputStream sink, Schema schema)
	{
		...
		auto __p = garrow_record_batch_stream_writer_new((sink is null) ? null : sink.getOutputStreamStruct(), (schema is null) ? null : schema.getSchemaStruct(), &err);
		...
		this(cast(GArrowRecordBatchStreamWriter*) __p, true);
	}
}
