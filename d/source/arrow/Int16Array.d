...
public class Int16Array : NumericArray
{
	...
	{
		auto __p = garrow_int16_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowInt16Array*) __p, true);
	}
	...
	public short[] getValues()
	{
		...
		auto __p = garrow_int16_array_get_values(gArrowInt16Array, &length);
	...
	public long sum()
	{
		...
		auto __p = garrow_int16_array_sum(gArrowInt16Array, &err);
