...
public class UIntArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_uint_array_builder_new();
		...
		this(cast(GArrowUIntArrayBuilder*) __p, true);
	}
	...
	public bool append(ulong value)
	{
		...
		auto __p = garrow_uint_array_builder_append(gArrowUIntArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_uint_array_builder_append_null(gArrowUIntArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_uint_array_builder_append_nulls(gArrowUIntArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(ulong value)
	{
		...
		auto __p = garrow_uint_array_builder_append_value(gArrowUIntArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(ulong[] values, bool[] isValids)
	{
		...
		auto __p = garrow_uint_array_builder_append_values(gArrowUIntArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
