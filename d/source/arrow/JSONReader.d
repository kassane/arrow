...
public class JSONReader : ObjectG
{
	...
	public this(InputStream input, JSONReadOptions options)
	{
		...
		auto __p = garrow_json_reader_new((input is null) ? null : input.getArrowInputStreamStruct(), (options is null) ? null : options.getJSONReadOptionsStruct(), &err);
		...
		this(cast(GArrowJSONReader*) __p, true);
	}
	...
	public Table read()
	{
		...
		auto __p = garrow_json_reader_read(gArrowJSONReader, &err);
