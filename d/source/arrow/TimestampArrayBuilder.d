...
public class TimestampArrayBuilder : ArrayBuilder
{
	...
	{
		auto __p = garrow_timestamp_array_builder_new((dataType is null) ? null : dataType.getTimestampDataTypeStruct());
		...
		this(cast(GArrowTimestampArrayBuilder*) __p, true);
	}
	...
	public bool append(long value)
	{
		...
		auto __p = garrow_timestamp_array_builder_append(gArrowTimestampArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_timestamp_array_builder_append_null(gArrowTimestampArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_timestamp_array_builder_append_nulls(gArrowTimestampArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(long value)
	{
		...
		auto __p = garrow_timestamp_array_builder_append_value(gArrowTimestampArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(long[] values, bool[] isValids)
	{
		...
		auto __p = garrow_timestamp_array_builder_append_values(gArrowTimestampArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
