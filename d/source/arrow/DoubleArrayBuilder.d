...
public class DoubleArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_double_array_builder_new();
		...
		this(cast(GArrowDoubleArrayBuilder*) __p, true);
	}
	...
	public bool append(double value)
	{
		...
		auto __p = garrow_double_array_builder_append(gArrowDoubleArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_double_array_builder_append_null(gArrowDoubleArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_double_array_builder_append_nulls(gArrowDoubleArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(double value)
	{
		...
		auto __p = garrow_double_array_builder_append_value(gArrowDoubleArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(double[] values, bool[] isValids)
	{
		...
		auto __p = garrow_double_array_builder_append_values(gArrowDoubleArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
