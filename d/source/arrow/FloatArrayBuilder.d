...
public class FloatArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_float_array_builder_new();
		...
		this(cast(GArrowFloatArrayBuilder*) __p, true);
	}
	...
	public bool append(float value)
	{
		...
		auto __p = garrow_float_array_builder_append(gArrowFloatArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_float_array_builder_append_null(gArrowFloatArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_float_array_builder_append_nulls(gArrowFloatArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(float value)
	{
		...
		auto __p = garrow_float_array_builder_append_value(gArrowFloatArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(float[] values, bool[] isValids)
	{
		...
		auto __p = garrow_float_array_builder_append_values(gArrowFloatArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
