...
public class UInt16ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_uint16_array_builder_new();
		...
		this(cast(GArrowUInt16ArrayBuilder*) __p, true);
	}
	...
	public bool append(ushort value)
	{
		...
		auto __p = garrow_uint16_array_builder_append(gArrowUInt16ArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_uint16_array_builder_append_null(gArrowUInt16ArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_uint16_array_builder_append_nulls(gArrowUInt16ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(ushort value)
	{
		...
		auto __p = garrow_uint16_array_builder_append_value(gArrowUInt16ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(ushort[] values, bool[] isValids)
	{
		...
		auto __p = garrow_uint16_array_builder_append_values(gArrowUInt16ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
