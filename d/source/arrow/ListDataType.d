...
public class ListDataType : DataType
{
	...
	{
		auto __p = garrow_list_data_type_new((field is null) ? null : field.getFieldStruct());
		...
		this(cast(GArrowListDataType*) __p, true);
	}
	...
	{
		auto __p = garrow_list_data_type_get_field(gArrowListDataType);
	...
	{
		auto __p = garrow_list_data_type_get_value_field(gArrowListDataType);
