...
public class ResizableBuffer : MutableBuffer
{
	...
	public this(long initialSize)
	{
		...
		auto __p = garrow_resizable_buffer_new(initialSize, &err);
		...
		this(cast(GArrowResizableBuffer*) __p, true);
	}
	...
	public bool reserve(long newCapacity)
	{
		...
		auto __p = garrow_resizable_buffer_reserve(gArrowResizableBuffer, newCapacity, &err) != 0;
	...
	public bool resize(long newSize)
	{
		...
		auto __p = garrow_resizable_buffer_resize(gArrowResizableBuffer, newSize, &err) != 0;
