...
public class SparseUnionDataType : UnionDataType
{
	 ...
	 */
	public this(ListG fields, byte[] typeCodes)
	{
		auto __p = garrow_sparse_union_data_type_new((fields is null) ? null : fields.getListGStruct(), typeCodes.ptr, cast(size_t)typeCodes.length);
		...
		this(cast(GArrowSparseUnionDataType*) __p, true);
	}
}
