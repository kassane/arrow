...
public class BooleanArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_boolean_array_builder_new();
		...
		this(cast(GArrowBooleanArrayBuilder*) __p, true);
	}
	...
	public bool append(bool value)
	{
		...
		auto __p = garrow_boolean_array_builder_append(gArrowBooleanArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_boolean_array_builder_append_null(gArrowBooleanArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_boolean_array_builder_append_nulls(gArrowBooleanArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(bool value)
	{
		...
		auto __p = garrow_boolean_array_builder_append_value(gArrowBooleanArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(bool[] values, bool[] isValids)
	{
		...
		auto __p = garrow_boolean_array_builder_append_values(gArrowBooleanArrayBuilder, valuesArray.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
