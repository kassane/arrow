...
public class IntArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_int_array_builder_new();
		...
		this(cast(GArrowIntArrayBuilder*) __p, true);
	}
	...
	public bool append(long value)
	{
		...
		auto __p = garrow_int_array_builder_append(gArrowIntArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_int_array_builder_append_null(gArrowIntArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_int_array_builder_append_nulls(gArrowIntArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(long value)
	{
		...
		auto __p = garrow_int_array_builder_append_value(gArrowIntArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(long[] values, bool[] isValids)
	{
		...
		auto __p = garrow_int_array_builder_append_values(gArrowIntArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
