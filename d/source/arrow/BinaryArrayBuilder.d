...
public class BinaryArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_binary_array_builder_new();
		...
		this(cast(GArrowBinaryArrayBuilder*) __p, true);
	}
	...
	public bool append(ubyte[] value)
	{
		...
		auto __p = garrow_binary_array_builder_append(gArrowBinaryArrayBuilder, value.ptr, cast(int)value.length, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_binary_array_builder_append_null(gArrowBinaryArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_binary_array_builder_append_nulls(gArrowBinaryArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(ubyte[] value)
	{
		...
		auto __p = garrow_binary_array_builder_append_value(gArrowBinaryArrayBuilder, value.ptr, cast(int)value.length, &err) != 0;
	...
	public bool appendValueBytes(Bytes value)
	{
		...
		auto __p = garrow_binary_array_builder_append_value_bytes(gArrowBinaryArrayBuilder, (value is null) ? null : value.getBytesStruct(), &err) != 0;
	...
	public bool appendValues(Bytes[] values, bool[] isValids)
	{
		...
		auto __p = garrow_binary_array_builder_append_values(gArrowBinaryArrayBuilder, valuesArray.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
