...
public class RecordBatchBuilder : ObjectG
{
	...
	public this(Schema schema)
	{
		...
		auto __p = garrow_record_batch_builder_new((schema is null) ? null : schema.getSchemaStruct(), &err);
		...
		this(cast(GArrowRecordBatchBuilder*) __p, true);
	}
	...
	public RecordBatch flush()
	{
		...
		auto __p = garrow_record_batch_builder_flush(gArrowRecordBatchBuilder, &err);
	...
	{
		auto __p = garrow_record_batch_builder_get_column_builder(gArrowRecordBatchBuilder, i);
	...
	{
		auto __p = garrow_record_batch_builder_get_field(gArrowRecordBatchBuilder, i);
	...
	{
		auto __p = garrow_record_batch_builder_get_schema(gArrowRecordBatchBuilder);
