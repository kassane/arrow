...
public class NullArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_null_array_builder_new();
		...
		this(cast(GArrowNullArrayBuilder*) __p, true);
	}
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_null_array_builder_append_null(gArrowNullArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_null_array_builder_append_nulls(gArrowNullArrayBuilder, n, &err) != 0;
