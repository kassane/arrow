...
public class Date64Array : NumericArray
{
	...
	{
		auto __p = garrow_date64_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowDate64Array*) __p, true);
	}
	...
	public long[] getValues()
	{
		...
		auto __p = garrow_date64_array_get_values(gArrowDate64Array, &length);
