...
public class DictionaryDataType : FixedWidthDataType
{
	...
	{
		auto __p = garrow_dictionary_data_type_new((indexDataType is null) ? null : indexDataType.getDataTypeStruct(), (valueDataType is null) ? null : valueDataType.getDataTypeStruct(), ordered);
		...
		this(cast(GArrowDictionaryDataType*) __p, true);
	}
	...
	{
		auto __p = garrow_dictionary_data_type_get_index_data_type(gArrowDictionaryDataType);
	...
	{
		auto __p = garrow_dictionary_data_type_get_value_data_type(gArrowDictionaryDataType);
