...
public class CSVReader : ObjectG
{
	...
	public this(InputStream input, CSVReadOptions options)
	{
		...
		auto __p = garrow_csv_reader_new((input is null) ? null : input.getArrowInputStreamStruct(), (options is null) ? null : options.getCSVReadOptionsStruct(), &err);
		...
		this(cast(GArrowCSVReader*) __p, true);
	}
	...
	public Table read()
	{
		...
		auto __p = garrow_csv_reader_read(gArrowCSVReader, &err);
