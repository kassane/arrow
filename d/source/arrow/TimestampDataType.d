...
/** */
public class TimestampDataType : TemporalDataType
{
	/** the main Gtk struct */
	...
	public this (GArrowTimestampDataType* gArrowTimestampDataType, bool ownedRef = false)
	{
		...
		super(cast(GArrowTemporalDataType*)gArrowTimestampDataType, ownedRef);
	}
	 ...
	 *     timeZone = The time zone of the timestamp data. If based GLib
	 ...
	 */
	public this(GArrowTimeUnit unit, TimeZone timeZone)
	{
		auto __p = garrow_timestamp_data_type_new(unit, (timeZone is null) ? null : timeZone.getTimeZoneStruct());
		...
		this(cast(GArrowTimestampDataType*) __p, true);
	}
