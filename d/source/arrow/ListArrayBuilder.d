...
public class ListArrayBuilder : ArrayBuilder
{
	...
	public this(ListDataType dataType)
	{
		...
		auto __p = garrow_list_array_builder_new((dataType is null) ? null : dataType.getListDataTypeStruct(), &err);
		...
		this(cast(GArrowListArrayBuilder*) __p, true);
	}
	...
	public bool append()
	{
		...
		auto __p = garrow_list_array_builder_append(gArrowListArrayBuilder, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_list_array_builder_append_null(gArrowListArrayBuilder, &err) != 0;
	...
	public bool appendValue()
	{
		...
		auto __p = garrow_list_array_builder_append_value(gArrowListArrayBuilder, &err) != 0;
	...
	{
		auto __p = garrow_list_array_builder_get_value_builder(gArrowListArrayBuilder);
