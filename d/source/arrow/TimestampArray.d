...
public class TimestampArray : NumericArray
{
	...
	{
		auto __p = garrow_timestamp_array_new((dataType is null) ? null : dataType.getTimestampDataTypeStruct(), length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowTimestampArray*) __p, true);
	}
	...
	public long[] getValues()
	{
		...
		auto __p = garrow_timestamp_array_get_values(gArrowTimestampArray, &length);
