...
public class UnionDataType : DataType
{
	...
	{
		auto __p = garrow_union_data_type_get_field(gArrowUnionDataType, i);
	...
	{
		auto __p = garrow_union_data_type_get_fields(gArrowUnionDataType);
	 ...
	 * Since: 0.12.0
	 */
	public byte[] getTypeCodes()
	{
		size_t nTypeCodes;

		auto __p = garrow_union_data_type_get_type_codes(gArrowUnionDataType, &nTypeCodes);

		return __p[0 .. nTypeCodes];
	}
}
