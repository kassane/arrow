...
public class UInt8ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_uint8_array_builder_new();
		...
		this(cast(GArrowUInt8ArrayBuilder*) __p, true);
	}
	...
	public bool append(ubyte value)
	{
		...
		auto __p = garrow_uint8_array_builder_append(gArrowUInt8ArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_uint8_array_builder_append_null(gArrowUInt8ArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_uint8_array_builder_append_nulls(gArrowUInt8ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(ubyte value)
	{
		...
		auto __p = garrow_uint8_array_builder_append_value(gArrowUInt8ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(ubyte[] values, bool[] isValids)
	{
		...
		auto __p = garrow_uint8_array_builder_append_values(gArrowUInt8ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
