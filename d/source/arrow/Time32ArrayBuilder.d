...
public class Time32ArrayBuilder : ArrayBuilder
{
	...
	{
		auto __p = garrow_time32_array_builder_new((dataType is null) ? null : dataType.getTime32DataTypeStruct());
		...
		this(cast(GArrowTime32ArrayBuilder*) __p, true);
	}
	...
	public bool append(int value)
	{
		...
		auto __p = garrow_time32_array_builder_append(gArrowTime32ArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_time32_array_builder_append_null(gArrowTime32ArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_time32_array_builder_append_nulls(gArrowTime32ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(int value)
	{
		...
		auto __p = garrow_time32_array_builder_append_value(gArrowTime32ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(int[] values, bool[] isValids)
	{
		...
		auto __p = garrow_time32_array_builder_append_values(gArrowTime32ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
