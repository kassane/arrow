...
public class UInt64ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_uint64_array_builder_new();
		...
		this(cast(GArrowUInt64ArrayBuilder*) __p, true);
	}
	...
	public bool append(ulong value)
	{
		...
		auto __p = garrow_uint64_array_builder_append(gArrowUInt64ArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_uint64_array_builder_append_null(gArrowUInt64ArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_uint64_array_builder_append_nulls(gArrowUInt64ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(ulong value)
	{
		...
		auto __p = garrow_uint64_array_builder_append_value(gArrowUInt64ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(ulong[] values, bool[] isValids)
	{
		...
		auto __p = garrow_uint64_array_builder_append_values(gArrowUInt64ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
