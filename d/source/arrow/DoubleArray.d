...
public class DoubleArray : NumericArray
{
	...
	{
		auto __p = garrow_double_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowDoubleArray*) __p, true);
	}
	...
	public double[] getValues()
	{
		...
		auto __p = garrow_double_array_get_values(gArrowDoubleArray, &length);
	...
	public double sum()
	{
		...
		auto __p = garrow_double_array_sum(gArrowDoubleArray, &err);
