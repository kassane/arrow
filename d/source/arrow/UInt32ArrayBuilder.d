...
public class UInt32ArrayBuilder : ArrayBuilder
{
	...
	public this()
	{
		auto __p = garrow_uint32_array_builder_new();
		...
		this(cast(GArrowUInt32ArrayBuilder*) __p, true);
	}
	...
	public bool append(uint value)
	{
		...
		auto __p = garrow_uint32_array_builder_append(gArrowUInt32ArrayBuilder, value, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_uint32_array_builder_append_null(gArrowUInt32ArrayBuilder, &err) != 0;
	...
	public override bool appendNulls(long n)
	{
		...
		auto __p = garrow_uint32_array_builder_append_nulls(gArrowUInt32ArrayBuilder, n, &err) != 0;
	...
	public bool appendValue(uint value)
	{
		...
		auto __p = garrow_uint32_array_builder_append_value(gArrowUInt32ArrayBuilder, value, &err) != 0;
	...
	public bool appendValues(uint[] values, bool[] isValids)
	{
		...
		auto __p = garrow_uint32_array_builder_append_values(gArrowUInt32ArrayBuilder, values.ptr, cast(long)values.length, isValidsArray.ptr, cast(long)isValids.length, &err) != 0;
