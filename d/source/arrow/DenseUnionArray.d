...
public class DenseUnionArray : UnionArray
{
	...
	public this(Int8Array typeIds, Int32Array valueOffsets, ListG fields)
	{
		...
		auto __p = garrow_dense_union_array_new((typeIds is null) ? null : typeIds.getInt8ArrayStruct(), (valueOffsets is null) ? null : valueOffsets.getInt32ArrayStruct(), (fields is null) ? null : fields.getListGStruct(), &err);
		...
		this(cast(GArrowDenseUnionArray*) __p, true);
	}
	...
	public this(DenseUnionDataType dataType, Int8Array typeIds, Int32Array valueOffsets, ListG fields)
	{
		...
		auto __p = garrow_dense_union_array_new_data_type((dataType is null) ? null : dataType.getDenseUnionDataTypeStruct(), (typeIds is null) ? null : typeIds.getInt8ArrayStruct(), (valueOffsets is null) ? null : valueOffsets.getInt32ArrayStruct(), (fields is null) ? null : fields.getListGStruct(), &err);
	...
	{
		return garrow_dense_union_array_get_value_offset(gArrowDenseUnionArray, i);
	}
}
