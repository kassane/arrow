...
public class StructArray : Array
{
	...
	{
		auto __p = garrow_struct_array_new((dataType is null) ? null : dataType.getDataTypeStruct(), length, (fields is null) ? null : fields.getListGStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowStructArray*) __p, true);
	}
	...
	public ListG flatten()
	{
		...
		auto __p = garrow_struct_array_flatten(gArrowStructArray, &err);
	...
	{
		auto __p = garrow_struct_array_get_field(gArrowStructArray, i);
	...
	{
		auto __p = garrow_struct_array_get_fields(gArrowStructArray);
