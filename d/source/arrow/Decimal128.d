...
public class Decimal128 : ObjectG
{
	...
	{
		auto __p = garrow_decimal128_new_integer(data);
		...
		this(cast(GArrowDecimal128*) __p, true);
	}
	 ...
	 * Params:
	 *     data = The data of the decimal.
	 * Returns: A newly created #GArrowDecimal128 on success, %NULL on error.
	 *
	 * Since: 0.10.0
	 *
	...
	public this(string data)
	{
		...
		auto __p = garrow_decimal128_new_string(Str.toStringz(data), &err);
	...
	/**
	 * Returns: A copied #GArrowDecimal128.
	 *
	 * Since: 3.0.0
	 */
	public Decimal128 copy()
	{
		auto __p = garrow_decimal128_copy(gArrowDecimal128);
		...
		return ObjectG.getDObject!(Decimal128)(cast(GArrowDecimal128*) __p, true);
	}
	...
	public Decimal128 divide(Decimal128 right, out Decimal128 remainder)
	{
		...
		auto __p = garrow_decimal128_divide(gArrowDecimal128, (right is null) ? null : right.getDecimal128Struct(), &outremainder, &err);
	...
	{
		auto __p = garrow_decimal128_minus(gArrowDecimal128, (right is null) ? null : right.getDecimal128Struct());
	...
	{
		auto __p = garrow_decimal128_multiply(gArrowDecimal128, (right is null) ? null : right.getDecimal128Struct());
	...
	{
		auto __p = garrow_decimal128_plus(gArrowDecimal128, (right is null) ? null : right.getDecimal128Struct());
	...
	public Decimal128 rescale(int originalScale, int newScale)
	{
		...
		auto __p = garrow_decimal128_rescale(gArrowDecimal128, originalScale, newScale, &err);
	...
	{
		auto __p = garrow_decimal128_to_bytes(gArrowDecimal128);
