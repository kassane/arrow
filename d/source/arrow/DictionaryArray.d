...
public class DictionaryArray : Array
{
	...
	public this(DataType dataType, Array indices, Array dictionary)
	{
		...
		auto __p = garrow_dictionary_array_new((dataType is null) ? null : dataType.getDataTypeStruct(), (indices is null) ? null : indices.getArrayStruct(), (dictionary is null) ? null : dictionary.getArrayStruct(), &err);
		...
		this(cast(GArrowDictionaryArray*) __p, true);
	}
	...
	{
		auto __p = garrow_dictionary_array_get_dictionary(gArrowDictionaryArray);
	 ...
	 *
	 *
	 * Deprecated: Use garrow_array_get_value_data_type() instead.
	 *
	...
	{
		auto __p = garrow_dictionary_array_get_dictionary_data_type(gArrowDictionaryArray);
		...
		return ObjectG.getDObject!(DictionaryDataType)(cast(GArrowDictionaryDataType*) __p, true);
	}
	...
	{
		auto __p = garrow_dictionary_array_get_indices(gArrowDictionaryArray);
