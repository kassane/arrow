...
public class StringArray : BinaryArray
{
	...
	{
		auto __p = garrow_string_array_new(length, (valueOffsets is null) ? null : valueOffsets.getBufferStruct(), (valueData is null) ? null : valueData.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowStringArray*) __p, true);
	}
