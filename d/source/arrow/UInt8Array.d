...
public class UInt8Array : NumericArray
{
	...
	{
		auto __p = garrow_uint8_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowUInt8Array*) __p, true);
	}
	...
	public ubyte[] getValues()
	{
		...
		auto __p = garrow_uint8_array_get_values(gArrowUInt8Array, &length);
	...
	public ulong sum()
	{
		...
		auto __p = garrow_uint8_array_sum(gArrowUInt8Array, &err);
