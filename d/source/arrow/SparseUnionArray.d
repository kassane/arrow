...
public class SparseUnionArray : UnionArray
{
	...
	public this(Int8Array typeIds, ListG fields)
	{
		...
		auto __p = garrow_sparse_union_array_new((typeIds is null) ? null : typeIds.getInt8ArrayStruct(), (fields is null) ? null : fields.getListGStruct(), &err);
		...
		this(cast(GArrowSparseUnionArray*) __p, true);
	}
	...
	public this(SparseUnionDataType dataType, Int8Array typeIds, ListG fields)
	{
		...
		auto __p = garrow_sparse_union_array_new_data_type((dataType is null) ? null : dataType.getSparseUnionDataTypeStruct(), (typeIds is null) ? null : typeIds.getInt8ArrayStruct(), (fields is null) ? null : fields.getListGStruct(), &err);
