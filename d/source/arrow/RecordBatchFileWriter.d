...
public class RecordBatchFileWriter : RecordBatchStreamWriter
{
	...
	public this(OutputStream sink, Schema schema)
	{
		...
		auto __p = garrow_record_batch_file_writer_new((sink is null) ? null : sink.getOutputStreamStruct(), (schema is null) ? null : schema.getSchemaStruct(), &err);
		...
		this(cast(GArrowRecordBatchFileWriter*) __p, true);
	}
}
