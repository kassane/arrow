...
public class StructArrayBuilder : ArrayBuilder
{
	...
	public this(StructDataType dataType)
	{
		...
		auto __p = garrow_struct_array_builder_new((dataType is null) ? null : dataType.getStructDataTypeStruct(), &err);
		...
		this(cast(GArrowStructArrayBuilder*) __p, true);
	}
	...
	public bool append()
	{
		...
		auto __p = garrow_struct_array_builder_append(gArrowStructArrayBuilder, &err) != 0;
	...
	public override bool appendNull()
	{
		...
		auto __p = garrow_struct_array_builder_append_null(gArrowStructArrayBuilder, &err) != 0;
	...
	public bool appendValue()
	{
		...
		auto __p = garrow_struct_array_builder_append_value(gArrowStructArrayBuilder, &err) != 0;
	 ...
	 *
	 *
	 * Deprecated: Use garrow_array_builder_get_child() instead.
	 *
	 * Params:
	...
	{
		auto __p = garrow_struct_array_builder_get_field_builder(gArrowStructArrayBuilder, i);
	 ...
	 *
	 *
	 * Deprecated: Use garrow_array_builder_get_children() instead.
	 *
	 * Returns: The #GArrowArrayBuilder for all fields.
	 */
	public ListG getFieldBuilders()
	{
		auto __p = garrow_struct_array_builder_get_field_builders(gArrowStructArrayBuilder);
