...
public class Int8Array : NumericArray
{
	...
	{
		auto __p = garrow_int8_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowInt8Array*) __p, true);
	}
	...
	public byte[] getValues()
	{
		...
		auto __p = garrow_int8_array_get_values(gArrowInt8Array, &length);
	...
	public long sum()
	{
		...
		auto __p = garrow_int8_array_sum(gArrowInt8Array, &err);
