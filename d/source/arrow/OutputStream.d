...
public class OutputStream : ObjectG, FileIF, WritableIF
{
	...
	public bool align_(int alignment)
	{
		...
		auto __p = garrow_output_stream_align(gArrowOutputStream, alignment, &err) != 0;
	 ...
	 * Throws: GException on failure.
	 */
	public long writeRecordBatch(RecordBatch recordBatch, WriteOptions options)
	{
		GError* err = null;

		auto __p = garrow_output_stream_write_record_batch(gArrowOutputStream, (recordBatch is null) ? null : recordBatch.getRecordBatchStruct(), (options is null) ? null : options.getWriteOptionsStruct(), &err);
	...
	public long writeTensor(Tensor tensor)
	{
		...
		auto __p = garrow_output_stream_write_tensor(gArrowOutputStream, (tensor is null) ? null : tensor.getTensorStruct(), &err);
