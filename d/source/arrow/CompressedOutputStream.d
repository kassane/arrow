...
public class CompressedOutputStream : OutputStream
{
	...
	public this(Codec codec, OutputStream raw)
	{
		...
		auto __p = garrow_compressed_output_stream_new((codec is null) ? null : codec.getCodecStruct(), (raw is null) ? null : raw.getOutputStreamStruct(), &err);
		...
		this(cast(GArrowCompressedOutputStream*) __p, true);
	}
}
