...
public class RecordBatchFileReader : ObjectG
{
	...
	public this(SeekableInputStream file)
	{
		...
		auto __p = garrow_record_batch_file_reader_new((file is null) ? null : file.getSeekableInputStreamStruct(), &err);
		...
		this(cast(GArrowRecordBatchFileReader*) __p, true);
	}
	...
	public RecordBatch getRecordBatch(uint i)
	{
		...
		auto __p = garrow_record_batch_file_reader_get_record_batch(gArrowRecordBatchFileReader, i, &err);
	...
	{
		auto __p = garrow_record_batch_file_reader_get_schema(gArrowRecordBatchFileReader);
	...
	public RecordBatch readRecordBatch(uint i)
	{
		...
		auto __p = garrow_record_batch_file_reader_read_record_batch(gArrowRecordBatchFileReader, i, &err);
