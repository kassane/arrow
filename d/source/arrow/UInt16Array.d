...
public class UInt16Array : NumericArray
{
	...
	{
		auto __p = garrow_uint16_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowUInt16Array*) __p, true);
	}
	...
	public ushort[] getValues()
	{
		...
		auto __p = garrow_uint16_array_get_values(gArrowUInt16Array, &length);
	...
	public ulong sum()
	{
		...
		auto __p = garrow_uint16_array_sum(gArrowUInt16Array, &err);
