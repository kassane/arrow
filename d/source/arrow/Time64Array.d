...
public class Time64Array : NumericArray
{
	...
	{
		auto __p = garrow_time64_array_new((dataType is null) ? null : dataType.getTime64DataTypeStruct(), length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowTime64Array*) __p, true);
	}
	...
	public long[] getValues()
	{
		...
		auto __p = garrow_time64_array_get_values(gArrowTime64Array, &length);
