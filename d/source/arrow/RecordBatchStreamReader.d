...
public class RecordBatchStreamReader : RecordBatchReader
{
	...
	public this(InputStream stream)
	{
		...
		auto __p = garrow_record_batch_stream_reader_new((stream is null) ? null : stream.getArrowInputStreamStruct(), &err);
		...
		this(cast(GArrowRecordBatchStreamReader*) __p, true);
	}
}
