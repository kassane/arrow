...
public class UInt64Array : NumericArray
{
	...
	{
		auto __p = garrow_uint64_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowUInt64Array*) __p, true);
	}
	...
	public ulong[] getValues()
	{
		...
		auto __p = garrow_uint64_array_get_values(gArrowUInt64Array, &length);
	...
	public ulong sum()
	{
		...
		auto __p = garrow_uint64_array_sum(gArrowUInt64Array, &err);
