...
public class SeekableInputStream : InputStream
{
	...
	public ulong getSize()
	{
		...
		auto __p = garrow_seekable_input_stream_get_size(gArrowSeekableInputStream, &err);
	...
	public Bytes peek(long nBytes)
	{
		...
		auto __p = garrow_seekable_input_stream_peek(gArrowSeekableInputStream, nBytes, &err);
	...
	public Buffer readAt(long position, long nBytes)
	{
		...
		auto __p = garrow_seekable_input_stream_read_at(gArrowSeekableInputStream, position, nBytes, &err);
	 ...
	 * Throws: GException on failure.
	 */
	public Bytes readAtBytes(long position, long nBytes)
	{
		GError* err = null;

		auto __p = garrow_seekable_input_stream_read_at_bytes(gArrowSeekableInputStream, position, nBytes, &err);
