...
public class BooleanArray : PrimitiveArray
{
	...
	{
		auto __p = garrow_boolean_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowBooleanArray*) __p, true);
	}
	...
	public BooleanArray and(BooleanArray right)
	{
		...
		auto __p = garrow_boolean_array_and(gArrowBooleanArray, (right is null) ? null : right.getBooleanArrayStruct(), &err);
	...
	public bool[] getValues()
	{
		...
		auto __p = garrow_boolean_array_get_values(gArrowBooleanArray, &length);
	...
	public BooleanArray invert()
	{
		...
		auto __p = garrow_boolean_array_invert(gArrowBooleanArray, &err);
	...
	public BooleanArray or(BooleanArray right)
	{
		...
		auto __p = garrow_boolean_array_or(gArrowBooleanArray, (right is null) ? null : right.getBooleanArrayStruct(), &err);
	...
	public BooleanArray xor(BooleanArray right)
	{
		...
		auto __p = garrow_boolean_array_xor(gArrowBooleanArray, (right is null) ? null : right.getBooleanArrayStruct(), &err);
