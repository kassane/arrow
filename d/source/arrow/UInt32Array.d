...
public class UInt32Array : NumericArray
{
	...
	{
		auto __p = garrow_uint32_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowUInt32Array*) __p, true);
	}
	...
	public uint[] getValues()
	{
		...
		auto __p = garrow_uint32_array_get_values(gArrowUInt32Array, &length);
	...
	public ulong sum()
	{
		...
		auto __p = garrow_uint32_array_sum(gArrowUInt32Array, &err);
