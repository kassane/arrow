...
public class Date32Array : NumericArray
{
	...
	{
		auto __p = garrow_date32_array_new(length, (data is null) ? null : data.getBufferStruct(), (nullBitmap is null) ? null : nullBitmap.getBufferStruct(), nNulls);
		...
		this(cast(GArrowDate32Array*) __p, true);
	}
	...
	public int[] getValues()
	{
		...
		auto __p = garrow_date32_array_get_values(gArrowDate32Array, &length);
