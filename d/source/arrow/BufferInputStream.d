...
public class BufferInputStream : SeekableInputStream
{
	...
	{
		auto __p = garrow_buffer_input_stream_new((buffer is null) ? null : buffer.getBufferStruct());
		...
		this(cast(GArrowBufferInputStream*) __p, true);
	}
	...
	{
		auto __p = garrow_buffer_input_stream_get_buffer(gArrowBufferInputStream);
